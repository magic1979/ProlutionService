...
function onDeviceReady() {
	...
	if(connectionStatus=='online'){
		...
		$("#noconn").html(tabella);
						  ...
						  $.ajax({
								 type:"GET",
								 url:"http://msop.it/artpizza/www/check_acquistati.asp",
								 contentType: "application/json",
								 data: {id:prod,OP:1},
								 jsonp: 'callback',
								 crossDomain: true,
