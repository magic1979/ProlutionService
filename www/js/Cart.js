	...
	db.transaction(function (tx) {
       tx.executeSql('SELECT * FROM Ordine', [], function (tx, results) {
					 ...
					 else
					 {
						...
						landmark = landmark + '<tr><td><font size="3">'+ results.rows.item(i).Nome +'</font></td><td><font size="3">'+ results.rows.item(i).Qta +'<font color="#000" size="1"> x('+ Number(Punita).toFixed(2) +'&euro;)</font></td><td><font size="3">'+ Number(results.rows.item(i).Descrizione).toFixed(2) +'&euro;</font></td><td align="center"><a id="meno'+ parseInt(results.rows.item(i).id) +'"><div width="28px" class="home"></div></a></td><td align="center"><a id="add'+ parseInt(results.rows.item(i).id) +'" ><div width="28px" class="home1"></div></td></tr>';
					 }
