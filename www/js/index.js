...
function RegToken(){
	//alert("entrato2")
		...
		$.ajax({
			   type:"GET",
			   url:"http://msop.it/pizzaelite/www/Check_RegToken.asp",
			   contentType: "application/json",
